    ...
    return <DrawerContentScrollView {...props}>
        <View style={styles.containerHeaderDrawer}>
            ...
            <View style={styles.contanierUser}>
                <MaterialCommunityIcons name='account-circle' color={mainColor} size={30}></MaterialCommunityIcons>
...
export const MyDrawerNavigation = () => {
    return (
        <Drawer.Navigator drawerContent={(props: any) => <CustomDrawer {...props} />}
            ...
            <Drawer.Screen name='myTab' component={TabNavigation} options={{
                drawerLabel: () =>
            ...
            <Drawer.Screen name='guideUse' component={HomePage} options={{
                drawerLabel: () =>
                    <ItemDrawer nameIcon='head-question-outline' nameFeature='Hướng dẫn đặt khám' />
            }}></Drawer.Screen>
        </Drawer.Navigator>
    )
}
